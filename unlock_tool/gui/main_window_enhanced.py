...
• Dark/Light theme support
    ...
    def create_compatibility_tab(self) -> QWidget:
        ...
        # Populate with sample data (convert dict to list if needed)
        devices = list(self.device_profiles.values()) if isinstance(self.device_profiles, dict) else self.device_profiles
        for idx, device in enumerate(devices[:10]):
